                ...
                if (data && data.completedQuestions) {
                    ...
                    $('.guidem-form').each(function() {
                        ...
                        if (completedQuestions.includes(questionNumber.toString())) {
                            ...
                            // Change the button text to "Completed" and set its style to green
                            ...
                            // Replace the form-control text with "You already completed this. Grit & Grind!"
                            $form.find('.form-control').text('You already completed this. Grit & Grind!');
