    ...
    function adjustLeftPaneHeight() {
        ...
        if (leftPane.length > 0) {
            ...
            if (leftPaneContent.length > 0) {
                ...
                var desiredScrollPosition = leftPaneContent[0].scrollHeight - containerHeight;
                console.log("Desired Scroll Position: " + desiredScrollPosition);

                // Set the scroll position to a specific point (e.g., 500 pixels from the top)
                leftPane.scrollTop(500); // Adjust the value as needed
                console.log("Scroll Position Set: 500 pixels");
            }
        }
    }
